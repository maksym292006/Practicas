...
const buttonVariants = cva(
  ...
  {
    variants: {
      // posibles variantes de estilos personalizables para los botones
      variant: {
        ...
        // PEROSONALIZACION DEL BOTON
        prueba: "bg-destructive hover:bg-chart-1",
      },
      // control de altura y padding
      size: {
        default:
    ...
    // Estilo por defecto , en el caso de que no se pase nada
    defaultVariants: {
      variant: "default",
      size: "default",
    },
